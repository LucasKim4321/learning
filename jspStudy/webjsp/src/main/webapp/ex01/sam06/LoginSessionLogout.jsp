...
<body>
	<!-- http://localhost:8080/webjsp/ex01/sam06/LoginSessionLogout.jsp -->
	
	<div class="container border">
		<div class="border login mx-auto">
			<h3>로그인 SessionCount</h3>
			<hr>
			<form action="/webjsp/loginSessionCount" method="get">  <!-- method="post"  요청 방식 변경   생략시 기본값 get-->
				<div>
