...
public class E07ChatClientTest {
	...
	public static void main(String[] args) {
		...
		String inMessage = null;  // 서버로부터 문자 받기
...
//			socket = new Socket("192.168.0.21",8888);  // 진우
			...
			while(true) {
				// 서버로 부터 전송받은 문자 확인
//				inMessage = br.readLine();  // 소켓에 있는 데이터를 읽어옴  // rThread가 기능
//				System.out.println(inMessage);  // 읽은 데이터를 본인컴퓨터에 출력  // rThread가 기능
