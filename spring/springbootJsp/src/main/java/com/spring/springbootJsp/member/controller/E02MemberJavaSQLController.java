...
public class E02MemberJavaSQLController {
	// MemberJavaSQLController.class에 대한 로그를 띄우겠다고 설정 미설정시 추후 로그 띄울때 에러
	static Logger logger = LoggerFactory.getLogger(E02MemberJavaSQLController.class);
...
//	private E03MemberDAOJavaSQL memberDAOJavaSQL;
	...
	// 생성자를 통해 의존성 주입
	public E02MemberJavaSQLController(E03MemberDAOJavaSQL memberDAOJavaSQL) {
